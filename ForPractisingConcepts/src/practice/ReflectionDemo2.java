...
//dynamic way...  old one...
p=(Politician)Class.forName("practice.AbcPolitician")
.getConstructor(new Class[] {String.class,String.class})
.newInstance("dynamicramu","dynamic father ramu");

System.out.println("dynamic ramu...:"+p);
//dynamic way .... new one  (they have achieved this through VARARGS
p=(Politician)Class.forName("practice.AbcPolitician").getConstructor(String.class,String.class).newInstance("new dynamicramu","new father dynamic ramu");
